...
# in D:\AndroidStudiowenjian\android-sdk-windows/tools/proguard/proguard-android.txt
...
#---------------------------------------------------------------------------------------------------
#---------------------------------实体类---------------------------------
-keep class [com.route.test.hungrydemo].** { *; }
...
-keep public class [com.route.test.hungrydemo].R$*{
